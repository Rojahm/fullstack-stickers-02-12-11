  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="w-[90%] lg:w-[80%] my-6 flex gap-2 leading-6 text-[19px] font-semibold">
        ...
        <Link href={"/sticker-packs"}>/ Sanario</Link>
        <div className="text-[#814997]">/ Hello Kitty</div>
      </div>
      <div className="mt-10 w-[90%] lg:w-[70%] flex flex-col gap-5 justify-center items-center md:flex-row rounded-3xl shadow-lg shadow-[#814997]/40 p-5">
        ...
        <div className="flex flex-col gap-5 md:w-[60%]">
          ...
          <p className="text-[#4e4a67] text-[0.8rem] leading-6">
            ...
            personifies charm and whimsy. Sanrio is a Japanese company, has been
            spreading joy and cuteness since its inception in 1960. Known
            worldwide for its design, licensing, and production of products
            centered around kawaii characters, it has solidified its position in
            the pop culture landscape. We are adding a fanart Sanrio sticker
            packs have become a beloved trend, amplifying the appeal of these
            characters in innovative and creative ways. In our fanart pack you
            can find many Sanrio characters in form of stickers you can stick on
            your screen.
          </p>
